...
public class Manager_CutTicket_Testing {
    @BeforeClass
    ...
    @Test(priority = 4)
    public void Cut_WithValidInput(){
        ...
        Response res = given()
                ...
                .when()
                .post(ApiForManagerConstants.CutTicketEndPoint_Manager);
    ...
    @Test(priority = 4)
    public void Cut_WithInValidSeatId(){
        BookingModel model = new BookingModel("72c13dfb-e798-4f","a615bc5b-ca79-4be7-90e8-ee2b486deeae");
        Response res = given()
                .contentType(ContentType.JSON)
                .body(model)
                .header("Authorization", "Bearer " + Manager_LogIn_Testing.Token)
    ...
    @Test(priority = 4)
    public void Cut_WithEmptySeatId(){
    ...
    @Test(priority = 4)
    public void Cut_WithInValidJourneyId(){
        BookingModel model = new BookingModel(  "72c13dfb-e798-4f13-bdb9-014eb5862c3c","a618-ee2b486deeab");
        Response res = given()
                .contentType(ContentType.JSON)
                .body(model)
                .header("Authorization","Bearer "+Manager_LogIn_Testing.Token)
    ...
    @Test(priority = 4)
    public void Cut_WithValidInputAndNoToken(){
    ...
    @Test(priority = 4)
    public void Cut_WithNotRealSeatId(){
        BookingModel model = new BookingModel( "72c13dfb-e798-4c13-bdb9-014eb5862c3f","a615bc5b-ca79-4be7-90e8-ee2b486deeae");
        Response res = given()
                .contentType(ContentType.JSON)
                .body(model)
                .header("Authorization", "Bearer " +Manager_LogIn_Testing.Token)
    ...
    @Test(priority = 4)
    public void Cut_WithEmptyJourneyId(){
    ...
    @Test(priority = 4)
    public void Cut_WithNotRealJourneyId(){
        BookingModel model = new BookingModel( "72c13dfb-e798-4f13-bdb9-014eb5862c3c","a614bc5b-ca79-4be7-90e8-ee2b486deeab");
        Response res = given()
                .contentType(ContentType.JSON)
                .body(model)
                .header("Authorization","Bearer "+Manager_LogIn_Testing.Token)
