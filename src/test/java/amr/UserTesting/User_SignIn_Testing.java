...
public class User_SignIn_Testing {
...
//      "user@example.com"
      LoginModel model = new LoginModel("rsad44sdAhsdfmed88888@example.com","@Aa123456789");
      Response res = given().log().all()
              .contentType(ContentType.JSON)
              .body(model)
           .when()
              .post(ApiForUserConstants.LogIn_User);
   ...
   public void SignIn_WithInValidPassword(){
      ...
      LoginModel model = new LoginModel("user@example.com","Aa123456789");
      Response res = given()
              .contentType(ContentType.JSON)
              .body(model)
              .when()
   ...
   public void SignIn_WithEmptyPassword(){
      ...
      LoginModel model = new LoginModel("user@example.com","");
      Response res = given()
              .contentType(ContentType.JSON)
              .body(model)
              .when()
   ...
   public void SignIn_WithWrongPassword(){
      LoginModel model = new LoginModel("user@example.com","@Aa12345678");
      Response res =given()
              .contentType(ContentType.JSON)
              .body(model)
              .when()
